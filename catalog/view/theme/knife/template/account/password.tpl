					...
					<div class="member-main-content address-book col-md-9">
						...
						<form action="<?php echo $action; ?>" method="post" enctype="multipart/form-data" class="form form-vertical form-change-pass">
							<div class="col-left">
								...
								<div class="form-group">
									<label for="inputReEnterPassword">Nhập lại mật khẩu: <span class="force">*</span></label>
									<?php if ($error_confirm) { ?>
										<span class="error"><?php echo $error_confirm; ?></span>
									<?php } ?>
									<input type="password" name="confirm" value="<?php echo $confirm; ?>" class="form-control warning">
								</div>
							</div>
