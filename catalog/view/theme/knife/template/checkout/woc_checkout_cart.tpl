  ...
  <table class="table">
    <thead>
      <tr>
        ...
        <td class="model"><?php echo $column_image; ?></td>
    ...
    <tbody>
      ...
      <tr>
        ...
        <td class="model"><img src="<?php echo $product['image']; ?>" /></td>
    ...
    <tfoot>
      ...
      <tr>
        ...
        <td class="total"><span style="color:Red;"><?php echo $total['text']; ?></span></td>
      </tr>
      <?php } ?>
    </tfoot>
  </table>
