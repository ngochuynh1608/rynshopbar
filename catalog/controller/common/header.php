...
class ControllerCommonHeader extends Controller {
	public function index() {
		...
		$data['shopping_checkout'] = $this->url->link('checkout/checkout','','SSL');
        ...
        $data['ct_href'] = $this->url->link('information/news&category=2');
        $data['news_href'] = $this->url->link('information/news&category=1');
        $data['contact_href'] = $this->url->link('information/contact');
        $data['landing_href'] = $server.'san-pham';
		$data['checkout'] = $this->url->link('checkout/checkout', '', 'SSL');
