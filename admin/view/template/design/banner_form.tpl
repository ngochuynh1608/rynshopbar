          ...
          <table id="images" class="table table-striped table-bordered table-hover">
            ...
            <tbody>
              ...
              <tr id="image-row<?php echo $image_row; ?>">
                ...
                <td class="text-left"><?php foreach ($languages as $language) { ?>
                  <div class="input-group pull-left"><span class="input-group-addon"><img src="view/image/flags/<?php echo $language['image']; ?>" title="<?php echo $language['name']; ?>" /> </span>
                    <textarea rows="5" name="banner_image[<?php echo $image_row; ?>][banner_image_description][<?php echo $language['language_id']; ?>][description]" value="" placeholder="<?php echo $entry_description; ?>" class="form-control">
                        <?php echo isset($banner_image['description'][$language['language_id']]) ? $banner_image['description'][$language['language_id']]['description'] : ''; ?>
                    </textarea>
                  </div>
                  <?php } ?></td>
                <td class="text-left" style="width: 20%;">
                    ...
                    <input type="text" class="form-control jscolor" value="<?php echo $banner_image['color']; ?>" name="banner_image[<?php echo $image_row; ?>][color]"/>
                </td>
